...
public class LifeGameFrame extends javax.swing.JFrame 
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        for (int i =0; i < 100; i++){
            grid[r.nextInt(100)][r.nextInt(100)] = 1;
        }
        draw();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        for (int i =0; i < 100; i++){
            for (int a =0; a < 100; a++){
                if(grid[i][a] == 0){grid[i][a] = 1;}
                else if(grid[i][a] == 1){grid[i][a] = 0;}
            }
        }
        draw();
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        for (int i = 0; i < 100; i++){
            for (int a = 0; a < 100; a++){
                int b = 0;
                if (grid[i][a] == 0){
                    if (((i - 1)>=0 && (a - 1)>=0) && grid[i - 1][a - 1] == 1){
                        b++;}
                    if ((a - 1)>=0 && grid[i][a - 1] == 1){
                        b++;}
                    if (((i + 1)<100 && (a - 1)>=0) && grid[i + 1][a - 1] == 1){
                        b++;}
                    if ((i - 1)>=0 && grid[i - 1][a] == 1){
                        b++;}
                    if ((i + 1)<100 && grid[i + 1][a] == 1){
                        b++;}
                    if (((i - 1)>=0 && (a + 1)<100) && grid[i - 1][a + 1] == 1){
                        b++;}
                    if ((a + 1)<100 && grid[i][a + 1] == 1){
                        b++;}
                    if (((i + 1)<100 && (a + 1)<100) && grid[i + 1][a + 1] == 1){
                        b++;}
                    if (b >= 2){
                        temp[i][a] = 1;}
                }
